...
const Budget = () => {
    ...
    const { budget, handleUpdateBudget, totalExpenses, currency } = useContext(AppContext);
...
<input type="number" step="10" value={newBudget} onChange={handleBudgetChange} min = "0" style={{ width: '120px' }}></input>
